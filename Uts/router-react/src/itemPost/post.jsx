...
class Post extends Component {
  ...
  handleSimpan = () => {
    if (this.state.insertProduk.total_qty <= 0) {
      ...
      this.state.insertProduk.total_qty != 0 &&
      this.state.insertProduk.total_qty <= this.props.stok
    ) {
      ...
      <div className="form">
        <table border="1">
          ...
          <tbody>
            <tr>
              <td rowSpan="4">
                <img src={this.props.image} className="image_center"></img>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td rowSpan="2">
                ...
                <input
                  ...
                  id="total_qty"
                  name="total_qty"
                  value={this.state.insertProduk.total_qty}
